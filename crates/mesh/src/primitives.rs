...
///
/// Defaults low-poly (§5). Limites (§44): lados 3–32, anéis 2–24, subdivisão ico 0–3,
/// torus 3–64/3–32, raios e alturas > 0 (clamp).
...
impl PrimitiveDescriptor {
    /// Identificador canônico da espécie ("box", "cylinder", "sphere", etc.).
