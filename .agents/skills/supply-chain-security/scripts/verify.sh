...
SKILL_ID="supply-chain-security"
...
check_grep "supply chain|dependency" "SKILL.md" "SKILL.md names supply-chain security"
check_grep "lockfile|signature|sbom" "SKILL.md" "SKILL.md covers provenance and inventory"
check_grep "typosquat|vulnerability|license" "SKILL.md" "SKILL.md covers dependency risks"
check_grep "risks|lockfile|sbom" "references/dependency-management.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/supply-chain-security-checklist.md" "Checklist contains verification items"
check_grep "inventory|remediation" "templates/supply-chain-security-report.md" "Template contains concrete report fields"
