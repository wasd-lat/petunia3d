...
check_grep "plugin|extension" "SKILL.md" "SKILL.md names plugin and extension security"
check_grep "capability|sandbox|broker" "SKILL.md" "SKILL.md covers capability isolation"
check_grep "manifest|provenance" "SKILL.md" "SKILL.md covers manifest provenance"
check_grep "core concepts|patterns|anti-patterns" "references/plugin-security-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/plugin-security-checklist.md" "Checklist contains verification items"
check_grep "capability matrix|remediation" "templates/plugin-security-report.md" "Template contains concrete report fields"
