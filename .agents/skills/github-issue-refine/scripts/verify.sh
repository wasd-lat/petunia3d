...
check_grep "refinement|issue" "SKILL.md" "SKILL.md names issue refinement"
check_grep "intent|acceptance criteria" "SKILL.md" "SKILL.md covers intent and testable scope"
check_grep "dependenc|milestone|non-goal" "SKILL.md" "SKILL.md covers dependency and scope control"
check_grep "intent preservation|testable criteria|non-goals" "references/github-issue-refine-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/github-issue-refine-checklist.md" "Checklist contains verification items"
check_grep "problem|dependencies|non-goals" "templates/issue-template.md" "Template contains concrete fields"
