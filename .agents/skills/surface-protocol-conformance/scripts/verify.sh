...
SKILL_ID="surface-protocol-conformance"
...
check_grep "surface|protocol" "SKILL.md" "SKILL.md names surfaces and protocol"
check_grep "domain source|permission engine" "SKILL.md" "SKILL.md covers shared domain governance"
check_grep "negotiation|replay" "SKILL.md" "SKILL.md covers version negotiation and replay"
check_grep "single domain source|conformance matrix" "references/surface-protocol-conformance-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/surface-protocol-conformance-checklist.md" "Checklist contains verification items"
check_grep "conformance matrix|replay evidence" "templates/surface-protocol-conformance-spec.md" "Template contains concrete evidence fields"
