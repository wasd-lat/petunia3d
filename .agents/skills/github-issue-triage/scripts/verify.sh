...
check_grep "triage|issue" "SKILL.md" "SKILL.md names issue triage"
check_grep "deduplicat|reproduc|priority" "SKILL.md" "SKILL.md covers qualification and prioritization"
check_grep "security|routing|milestone" "SKILL.md" "SKILL.md covers routing and disclosure"
check_grep "deduplication|priority|sla" "references/triage_process.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/github-issue-triage-checklist.md" "Checklist contains verification items"
check_grep "decision|evidence|follow-up" "templates/issue-template.md" "Template contains concrete fields"
