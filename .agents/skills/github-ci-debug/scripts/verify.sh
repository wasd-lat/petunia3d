...
check_grep "ci|workflow" "SKILL.md" "SKILL.md names GitHub CI"
check_grep "matrix|runner|cache" "SKILL.md" "SKILL.md covers matrix and runner failures"
check_grep "rerun|flaky|secret" "SKILL.md" "SKILL.md covers verification and log hygiene"
check_grep "failure classification|local reproduction" "references/github-ci-debug-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/github-ci-debug-checklist.md" "Checklist contains verification items"
check_grep "classification|first error|fix and evidence" "templates/issue-template.md" "Template contains concrete evidence fields"
