...
check_grep "issue|gh issue" "SKILL.md" "SKILL.md names issue authoring and automation"
check_grep "reproduction|acceptance criteria" "SKILL.md" "SKILL.md requires actionable evidence"
check_grep "sensitive|severity|labels" "SKILL.md" "SKILL.md covers issue hygiene"
check_grep "good issue|reproduction|anti-pattern" "references/issue_guidelines.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/github-issue-create-checklist.md" "Checklist contains verification items"
check_grep "context and reproduction|acceptance criteria|technical notes" "templates/issue-template.md" "Template contains concrete fields"
