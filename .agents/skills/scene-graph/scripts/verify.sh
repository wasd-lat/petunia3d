...
check_grep "scene graph|ecs" "SKILL.md" "SKILL.md names the scene graph and ECS domain"
check_grep "generation|determin" "SKILL.md" "SKILL.md covers entity identity and determinism"
check_grep "transform|system" "SKILL.md" "SKILL.md covers hierarchy and scheduling"
check_grep "core concepts|patterns|anti-patterns" "references/scene-graph-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/scene-graph-invariants.md" "Checklist contains verification items"
check_grep "storage and scheduling|evidence" "templates/scene-graph-template.md" "Template contains concrete evidence fields"
