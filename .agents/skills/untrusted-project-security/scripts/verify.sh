...
SKILL_ID="untrusted-project-security"
...
check_grep "untrusted|quarantine" "SKILL.md" "SKILL.md names untrusted project security"
check_grep "static|sandbox|network egress" "SKILL.md" "SKILL.md covers quarantine controls"
check_grep "hook|payload|human" "SKILL.md" "SKILL.md covers triggers and authorization"
check_grep "zero-trust|execution trigger|sandbox" "references/untrusted-project-security-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/untrusted-project-security-checklist.md" "Checklist contains verification items"
check_grep "static evidence|verdict" "templates/untrusted-project-security-report.md" "Template contains concrete report fields"
