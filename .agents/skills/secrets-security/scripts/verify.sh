...
check_grep "secret|credential" "SKILL.md" "SKILL.md names secret and credential security"
check_grep "hardcoded|redact|rotate" "SKILL.md" "SKILL.md covers prevention, redaction, and rotation"
check_grep "vault|oidc|secret manager" "SKILL.md" "SKILL.md covers managed credentials"
check_grep "never hardcode|secrets manager|scan" "references/secrets-management.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/secrets-security-checklist.md" "Checklist contains verification items"
check_grep "exposure review|remediation" "templates/secrets-security-report.md" "Template contains concrete report fields"
