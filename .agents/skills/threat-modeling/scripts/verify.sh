...
check_grep "threat model|stride" "SKILL.md" "SKILL.md names threat modeling"
check_grep "trust boundar|attack surface" "SKILL.md" "SKILL.md covers boundaries and attack surface"
check_grep "abuse|mitigation" "SKILL.md" "SKILL.md covers abuse cases and mitigations"
check_grep "spoofing|tampering|elevation" "references/stride-methodology.md" "Reference guide has STRIDE domain content"
check_grep "- \[ \]" "checks/threat-modeling-checklist.md" "Checklist contains verification items"
check_grep "trust boundaries|prioritized threats|decisions" "templates/threat-modeling-report.md" "Template contains concrete report fields"
