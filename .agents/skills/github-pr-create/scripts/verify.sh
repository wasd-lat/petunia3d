...
check_grep "pull request|gh pr" "SKILL.md" "SKILL.md names PR authoring and automation"
check_grep "atomic|conventional|diff" "SKILL.md" "SKILL.md covers scope and title discipline"
check_grep "evidence|breaking change|review" "SKILL.md" "SKILL.md covers readiness and disclosure"
check_grep "branching|commits|review readiness" "references/pr_best_practices.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/github-pr-create-checklist.md" "Checklist contains verification items"
check_grep "objective|verification|linked issues" "templates/issue-template.md" "Template contains concrete fields"
