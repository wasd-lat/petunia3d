...
check_grep "release|github" "SKILL.md" "SKILL.md names release packaging"
check_grep "semver|tag|checksum" "SKILL.md" "SKILL.md covers versioning and integrity"
check_grep "breaking|asset|changelog" "SKILL.md" "SKILL.md covers notes and build evidence"
check_grep "semver discipline|asset integrity|tag-sha" "references/github-release-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/github-release-checklist.md" "Checklist contains verification items"
check_grep "version intent|assets|evidence" "templates/issue-template.md" "Template contains concrete fields"
