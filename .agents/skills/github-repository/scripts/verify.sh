...
check_grep "repository|branch protection" "SKILL.md" "SKILL.md names repository management"
check_grep "secret|environment|codeowners" "SKILL.md" "SKILL.md covers repository governance"
check_grep "snapshot|negative proof|api" "SKILL.md" "SKILL.md covers verified mutations"
check_grep "branch protection|secret scoping|codeowners" "references/github-repository-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/github-repository-checklist.md" "Checklist contains verification items"
check_grep "applied policy|verification|repository" "templates/issue-template.md" "Template contains concrete fields"
