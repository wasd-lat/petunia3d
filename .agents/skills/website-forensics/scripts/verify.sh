...
check_grep "website|forensic" "SKILL.md" "SKILL.md names website forensics"
check_grep "public|measure|viewport" "SKILL.md" "SKILL.md covers public measurement scope"
check_grep "token|contrast|state" "SKILL.md" "SKILL.md covers token and interaction findings"
check_grep "scoped teardown|viewport ladder" "references/website-forensics-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/website-forensics-checklist.md" "Checklist contains verification items"
check_grep "measurements|cautions|recommendation" "templates/wireframe-spec.md" "Template contains concrete evidence fields"
