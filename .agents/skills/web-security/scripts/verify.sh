...
check_grep "web application|xss|csrf" "SKILL.md" "SKILL.md names web security threats"
check_grep "csp|ssrf|cookie" "SKILL.md" "SKILL.md covers browser and network controls"
check_grep "cors|upload|redirect" "SKILL.md" "SKILL.md covers common web misconfigurations"
check_grep "content security policy|nonce|frame-ancestors" "references/csp-guide.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/web-security-checklist.md" "Checklist contains verification items"
check_grep "controls verified|evidence" "templates/web-security-report.md" "Template contains concrete report fields"
