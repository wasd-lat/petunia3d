...
check_grep "security review|threat model" "SKILL.md" "SKILL.md names security review and threat modeling"
check_grep "sast|authorization|secret" "SKILL.md" "SKILL.md covers review gates and boundaries"
check_grep "regression|independent verifier" "SKILL.md" "SKILL.md requires evidence and independent review"
check_grep "data flow|access control|cryptography" "references/code-review-guide.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/security-review-checklist.md" "Checklist contains verification items"
check_grep "review method|verdict" "templates/security-review-report.md" "Template contains concrete report fields"
