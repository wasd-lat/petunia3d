...
check_grep "feedback|review thread" "SKILL.md" "SKILL.md names PR feedback handling"
check_grep "classif|blocking|reply" "SKILL.md" "SKILL.md covers thread disposition"
check_grep "regression|re-request|unresolved" "SKILL.md" "SKILL.md covers closure and evidence"
check_grep "thread inventory|minimal targeted diffs|reply-before-resolve" "references/github-pr-feedback-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/github-pr-feedback-checklist.md" "Checklist contains verification items"
check_grep "thread disposition|verification|unresolved" "templates/issue-template.md" "Template contains concrete fields"
