...
SKILL_ID="visual-reference-research"
...
check_grep "visual|reference" "SKILL.md" "SKILL.md names visual research"
check_grep "provenance|token|contrast" "SKILL.md" "SKILL.md covers provenance and accessibility"
check_grep "direction|exclusion" "SKILL.md" "SKILL.md requires a converged recommendation"
check_grep "moodboard|token extraction|convergence" "references/visual-reference-research-guide.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/visual-reference-research-checklist.md" "Checklist contains verification items"
check_grep "recommended direction|token draft|exclusions" "templates/wireframe-spec.md" "Template contains concrete evidence fields"
