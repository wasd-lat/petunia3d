...
check_grep "input validation|output encoding|secure coding" "SKILL.md" "SKILL.md names secure coding controls"
check_grep "injection|buffer|integer overflow" "SKILL.md" "SKILL.md covers memory and injection safety"
check_grep "least privilege|fail securely" "SKILL.md" "SKILL.md covers secure failure and privilege"
check_grep "input validation|parameterized|access control" "references/owasp-secure-coding-practices.md" "Reference guide has domain practices"
check_grep "- \[ \]" "checks/secure-coding-checklist.md" "Checklist contains verification items"
check_grep "controls implemented|evidence" "templates/secure-coding-report.md" "Template contains concrete report fields"
