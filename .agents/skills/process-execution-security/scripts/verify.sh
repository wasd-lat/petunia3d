...
SKILL_ID="process-execution-security"
...
check_grep "subprocess|process execution|shell" "SKILL.md" "SKILL.md names process execution"
check_grep "allowlist|environment|timeout" "SKILL.md" "SKILL.md covers execution controls"
check_grep "injection|privilege|process group" "SKILL.md" "SKILL.md covers injection and cleanup"
check_grep "primary defense|argument|shell" "references/command-injection-prevention.md" "Reference guide explains command injection"
check_grep "- \[ \]" "checks/process-execution-security-checklist.md" "Checklist contains verification items"
check_grep "controls verified|remediation" "templates/process-execution-security-report.md" "Template contains concrete report fields"
