...
check_grep "refactor|smell" "SKILL.md" "SKILL.md names refactoring and smells"
check_grep "regression|characterization" "SKILL.md" "SKILL.md requires behavior-preserving tests"
check_grep "extract method|inline|strangler" "SKILL.md" "SKILL.md names refactoring patterns"
check_grep "extract method|inline method|pattern" "references/refactoring-patterns.md" "Reference guide has domain patterns"
check_grep "- \[ \]" "checks/refactoring-invariants.md" "Checklist contains verification items"
check_grep "baseline|verification|follow-up" "templates/refactoring-template.md" "Template contains concrete evidence fields"
